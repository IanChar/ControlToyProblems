"""
This is largely the same code as the original Gym cart pole problem. See the
original code at
...
class CtsCartPoleEnv(gym.Env):
    """
    Description:
        Continuous action version of Gym's cartpole problem. This is largely
        the same code, but with the action space tweaked.
